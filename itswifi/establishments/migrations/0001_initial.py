    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=250, verbose_name='Endere\xe7o')),
                ...
                ('category', models.IntegerField(choices=[(1, 'Caf\xe9'), (2, 'Restaurante'), (3, 'Coworking'), (4, 'Livraria'), (5, 'Outro')], default=1, verbose_name='Tipo')),
            ],
        ),
        migrations.CreateModel(
